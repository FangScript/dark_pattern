# Dark Pattern Hunter Contribution Guide

Thanks for showing interest in contributing to Dark Pattern Hunter. Before starting your contribution, please take a moment to read the following guidelines.
...
If you see `REPLACE_ME_WITH_REPORT_HTML` in the report file, it's usually because of the circular dependency issue of Dark Pattern Hunter. You can rebuild the entire project without nx cache to solve this issue.
...
DPH_MODEL_NAME="gpt-4o-2024-08-06"
```
...
# Test with AI-related features, it will need to create a .env file
npx nx test:ai @darkpatternhunter/web
```

### Run E2E Tests

Dark Pattern Hunter uses
...
```sh
npx nx e2e @darkpatternhunter/web
```
...
All Dark Pattern Hunter packages will use a fixed unified version.

The release notes are automatically generated by [GitHub releases](https://github.com/darkpatternhunter/dark-pattern-hunter/releases).
...
1. [Run the release action](https://github.com/darkpatternhunter/dark-pattern-hunter/actions/workflows/release.yml).
2. [Generate the release notes](https://github.com/darkpatternhunter/dark-pattern-hunter/releases).
...
- Select the `apps/chrome-extension/extension_output/dark-pattern-hunter-extension-v{version}.zip` file
...
Due to some issues with circular dependencies, you need to execute the full build process within the entire repository to compile the Dark Pattern Hunter project, rather than compiling the ⁠@darkpatternhunter/core package separately.
