...
const AUTO_ZOOM_KEY = 'dph-auto-zoom';
const BACKGROUND_VISIBLE_KEY = 'dph-background-visible';
const ELEMENTS_VISIBLE_KEY = 'dph-elements-visible';
...
const SERVICE_MODE_KEY = 'dph-service-mode';
const TRACKING_ACTIVE_TAB_KEY = 'dph-tracking-active-tab';
const DEEP_THINK_KEY = 'dph-deep-think';
const SCREENSHOT_INCLUDED_KEY = 'dph-screenshot-included';
const DOM_INCLUDED_KEY = 'dph-dom-included';
